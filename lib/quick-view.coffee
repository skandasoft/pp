...
module.exports =
class QuickView extends ScrollView
  ...
  @content: ()->
    @div class: 'atom-text-panel qv-scroll', =>
      @div class:'pp-resizer-drag', mousedown: 'dragStart'
  ...
  initialize:  ->
    ...
    @view().find('atom-text-editor').css 'overflow','auto'
    # @view().find('atom-text-editor').parent().css 'overflow','auto'
    # @view().find('atom-text-editor').parent().parent().css 'overflow','auto'
